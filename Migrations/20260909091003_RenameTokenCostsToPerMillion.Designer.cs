...
namespace AiHelpers.Migrations
{
    ...
    [Migration("20260909091003_RenameTokenCostsToPerMillion")]
    partial class RenameTokenCostsToPerMillion
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AiHelpers.Data.Entities.AccessLogEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AiHelpers.Data.Entities.DataQueryExecutionLog", b =>
                {
                    ...
                    b.Property<int?>("HelperDataQueryId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AiHelpers.Data.Entities.DataSourceDefinition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("CompactionEnabled")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("AiHelpers.Data.Entities.HelperDataQuery", b =>
                {
                    ...
                    b.Property<int>("DataSourceDefinitionId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DataSourceDefinitionId");
            ...
            modelBuilder.Entity("AiHelpers.Data.Entities.HelperDefinition", b =>
                {
                    ...
                    b.Property<bool>("IsContextDriven")
                        .HasColumnType("bit");
                    ...
                    b.Property<string>("KnowledgeDistilledText")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<bool>("KnowledgeOptimizationEnabled")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("AiHelpers.Data.Entities.LlmDefinition", b =>
                {
                    ...
                    b.Property<bool>("UsesAdaptiveThinking")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("AiHelpers.Data.Entities.DataQueryExecutionLog", b =>
                {
                    b.HasOne("AiHelpers.Data.Entities.HelperDataQuery", "HelperDataQuery")
                        .WithMany()
                        .HasForeignKey("HelperDataQueryId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.Navigation("HelperDataQuery");
                });

            modelBuilder.Entity("AiHelpers.Data.Entities.DataSourceDefinition", b =>
                {
                    b.HasOne("AiHelpers.Data.Entities.DataConnection", "DataConnection")
            ...
            modelBuilder.Entity("AiHelpers.Data.Entities.GeneratedDocument", b =>
                {
                    ...
                    b.HasOne("AiHelpers.Data.Entities.Stylesheet", "Stylesheet")
                        .WithMany()
            ...
            modelBuilder.Entity("AiHelpers.Data.Entities.HelperDataQuery", b =>
                {
                    b.HasOne("AiHelpers.Data.Entities.DataSourceDefinition", "DataSourceDefinition")
                        .WithMany("Attachments")
                        .HasForeignKey("DataSourceDefinitionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.Navigation("DataSourceDefinition");
